...
export function RadicalEntryPage({ id, unlockedKanji, unlockedRadicals, favorites, customNames, notes, chatMsgs, onBack, onToggleFav, onSetName, onSetNote, onChat, onNavKanji, onNavRadical }: {
